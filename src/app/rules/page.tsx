...
export default async function GamesPage() {
  return (
    <div className="text-content">
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              If you haven&quot;t moved both chips by the end of the round, you
        ...
        <li>
          ...
          <ul>
            <li>
              Purple chips try to &quot;catch&quot; green chips to gain points.
            </li>
            <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              A player&quot;s final score is the sum of points from their green
              and purple chips.
            </li>
          </ul>
        </li>
      ...
      <p>
        TonDash is a dynamic game that requires quick decision-making and
        strategic thinking. Good luck and enjoy the game!
      </p>
    </div>
  );
}
